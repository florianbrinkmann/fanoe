...
class Fanoe_Social_Media_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id( 'google_plus' ); ?>"
			       name="<?php echo $this->get_field_name( 'google_plus' ); ?>" type="text"
		...
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id( 'picasa' ); ?>"
			       name="<?php echo $this->get_field_name( 'picasa' ); ?>" type="text"
			       value="<?php echo esc_attr( $picasa ); ?>"/>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'deviantart' ); ?>"><?php echo 'Deviantart:'; ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'deviantart' ); ?>"
			       name="<?php echo $this->get_field_name( 'deviantart' ); ?>" type="text"
		...
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id( 'lastfm' ); ?>"
			       name="<?php echo $this->get_field_name( 'lastfm' ); ?>" type="text"
			       value="<?php echo esc_attr( $lastfm ); ?>"/>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'foursquare' ); ?>"><?php echo 'Foursquare:'; ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'foursquare' ); ?>"
			       name="<?php echo $this->get_field_name( 'foursquare' ); ?>" type="text"
			       value="<?php echo esc_attr( $foursquare ); ?>"/>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'appnet' ); ?>"><?php echo 'app.net:'; ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'appnet' ); ?>"
			       name="<?php echo $this->get_field_name( 'appnet' ); ?>" type="text"
			       value="<?php echo esc_attr( $appnet ); ?>"/>
		</p>
		<p>
		...
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id( 'wordpress' ); ?>"
			       name="<?php echo $this->get_field_name( 'wordpress' ); ?>" type="text"
		...
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id( 'xing' ); ?>"
			       name="<?php echo $this->get_field_name( 'xing' ); ?>" type="text"
